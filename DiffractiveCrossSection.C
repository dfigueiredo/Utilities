...
std::string datafile_w_muon, datafile_w_electron, datafile_z_muon, datafile_z_electron;
std::string mcfile_w_muon_bkg, mcfile_w_electron_bkg, mcfile_z_muon_bkg, mcfile_z_electron_bkg;
std::string mcfile_w_muon_signal, mcfile_w_electron_signal, mcfile_z_muon_signal, mcfile_z_electron_signal;
...
void DiffractiveCrossSection(){

  // Files
  datafile_w_muon = "histo_W_muon_reco.root";
  datafile_w_electron = "histo_W_electron_reco.root";
  datafile_z_muon = "histo_Z_muon_reco.root";
  datafile_z_electron = "histo_Z_electron_reco.root";

  mcfile_w_muon_bkg = "histo_W_bkg_muon_reco.root";
  mcfile_w_electron_bkg = "histo_W_bkg_electron_reco.root";
  mcfile_z_muon_bkg = "histo_Z_bkg_muon_reco.root";
  mcfile_z_electron_bkg = "histo_Z_bkg_electron_reco.root";

  mcfile_w_muon_signal = "histo_W_signal_muon_reco.root";
  mcfile_w_electron_signal = "histo_W_signal_electron_reco.root";
  ...
  if(translate){
    ...
    luminosity ="Todos os canais (7 TeV)";
    titleYsigma = "Assimetria";
  }else{
    legdata = "Data";
    titleY = "Events";
    cmstitle = "CMS Preliminary";
    luminosity ="All channels (7 TeV)";
    titleYsigma = "Asymmetry";
  }

  // Luminosity
  lumi_w_muon = 25.216;
  lumi_w_electron = 24.229;
  lumi_z_muon = 25.465;
  lumi_z_electron = 24.551;
  ...
  // hname_W, hname_Z
  //MyOfficialCMS("BosonKinematics/BosonWMass_single_step7","LeptonsKinematics/BosonZMass_single_step8");
  //MyOfficialCMS("BosonKinematics/BosonWEta_single_step7","LeptonsKinematics/BosonZEta_single_step8");
  MyOfficialCMS("BosonKinematics/BosonWEta_single_NGapCMS","LeptonsKinematics/BosonZEta_single_NGapCMS");
  //MyOfficialCMS("BosonKinematics/BosonWEta_single_NGapCASTOR","LeptonsKinematics/BosonZEta_single_NGapCASTOR");
  //MyOfficialCMS("BosonKinematics/BosonWEta_single_NGapCMSAndCASTOR","LeptonsKinematics/BosonZEta_single_NGapCMSAndCASTOR");
  //MyOfficialCMS("BosonKinematics/BosonWEta_single_PGapCMSAndCASTOR","LeptonsKinematics/BosonZEta_single_PGapCMSAndCASTOR");
  //MyOfficialCMS("Detector/sumEEEminus_single_step7","Detector/sumEEEminus_single_step8");
  //MyOfficialCMS("Detector/sumEHFplus_single_step7","Detector/sumEHFplus_single_step8");
  //MyOfficialCMS("Detector/sumEHFplus_S_single_step7","Detector/sumEHFplus_S_single_step8");  
  //MyOfficialCMS("Detector/sumEHFplus_L_single_step7","Detector/sumEHFplus_L_single_step8");
  //MyOfficialCMS("Detector/sumEHFminus_single_step7","Detector/sumEHFminus_single_step8");
  //MyOfficialCMS("Detector/sumEHFminus_S_single_step7","Detector/sumEHFminus_S_single_step8");
  //MyOfficialCMS("Detector/sumEHFminus_L_single_step7","Detector/sumEHFminus_L_single_step8");
  //MyOfficialCMS("Detector/sumECastorMinus_single_step7","Detector/sumECastorMinus_single_step8");
  //MyOfficialCMS("Detector/sumEHFMax_single_step7","Detector/sumEHFMax_single_step8");
  //MyOfficialCMS("Detector/sumEHFMin_single_step7","Detector/sumEHFMin_single_step8");
  //MyOfficialCMS("Detector/sumEHEminus_single_step7","Detector/sumEHEminus_single_step8");
  //MyOfficialCMS("Detector/sumEHEplus_single_step7","Detector/sumEHEplus_single_step8");
  //MyOfficialCMS("Detector/sumECastorAndSumHFMinus_single_step7","Detector/sumECastorAndSumHFMinus_single_step8");
  //MyOfficialCMS("Run/TracksMultiplicity_single_step7","Run/Tracks_single_step8");
  //MyOfficialCMS("Run/vertex_single_step7","Run/vertex_single_step8");
  //MyOfficialCMS("Diffraction/deltaEtamaxmin_single_step7","Diffraction/deltaEtamaxmin_single_step8");
  //MyOfficialCMS("Diffraction/AEcastor_single_step7","Diffraction/AEcastor_single_step8");
  //MyOfficialCMS("Diffraction/etasignedHF_single_step7","Diffraction/etasignedHF_single_step8");
  //MyOfficialCMS("Diffraction/etasignedCASTOR_single_step7","Diffraction/etasignedCASTOR_single_step8");
  //MyOfficialCMS("Diffraction/xiMinus_single_step7","Diffraction/xiMinus_single_step8");
  //MyOfficialCMS("Diffraction/xiPlus_single_step7","Diffraction/xiPlus_single_step8");
  //MyOfficialCMS("Diffraction/SumPTMingap_single_step7","Diffraction/SumPTMingap_single_step8");
  //MyOfficialCMS("Diffraction/SumPTMaxgap_single_step7","Diffraction/SumPTMaxgap_single_step8");
  //MyOfficialCMS("Diffraction/maxetagap_single_NGapCASTOR","Diffraction/maxetagap_single_NGapCASTOR");
  //MyOfficialCMS("Diffraction/etamin_single_step7","Diffraction/etamin_single_step8");
  //MyOfficialCMS("Diffraction/etamax_single_step7","Diffraction/etamax_single_step8");
  //MyOfficialCMS("Diffraction/mHF_single_step7","Diffraction/mHF_single_step8");
...
void loadFiles(TString hname_w, TString hname_z){

  gStyle->SetOptFit(0);
  gStyle->SetOptStat(0);
  gStyle->SetOptTitle(0);

  TFile *ldata_w_muon  = TFile::Open(datafile_w_muon.c_str());
  TFile *ldata_w_electron  = TFile::Open(datafile_w_electron.c_str());
  TFile *ldata_z_muon  = TFile::Open(datafile_z_muon.c_str());
  TFile *ldata_z_electron  = TFile::Open(datafile_z_electron.c_str());

  TFile *lmc_w_muon_bkg  = TFile::Open(mcfile_w_muon_bkg.c_str());
  TFile *lmc_w_electron_bkg  = TFile::Open(mcfile_w_electron_bkg.c_str());
  TFile *lmc_z_muon_bkg  = TFile::Open(mcfile_z_muon_bkg.c_str());
  TFile *lmc_z_electron_bkg  = TFile::Open(mcfile_z_electron_bkg.c_str());

  TFile *lmc_w_muon_signal  = TFile::Open(mcfile_w_muon_signal.c_str());
  TFile *lmc_w_electron_signal  = TFile::Open(mcfile_w_electron_signal.c_str());
  ...
  TH1F* h_data_w_muon = (TH1F*)ldata_w_muon->Get(hname_w);
  TH1F* h_data_w_electron = (TH1F*)ldata_w_electron->Get(hname_w);
  TH1F* h_data_z_muon = (TH1F*)ldata_z_muon->Get(hname_z);
  TH1F* h_data_z_electron = (TH1F*)ldata_z_electron->Get(hname_z);

  TH1F* h_mc_w_muon_bkg = (TH1F*)lmc_w_muon_bkg->Get(hname_w);
  TH1F* h_mc_w_electron_bkg = (TH1F*)lmc_w_electron_bkg->Get(hname_w);
  TH1F* h_mc_z_muon_bkg = (TH1F*)lmc_z_muon_bkg->Get(hname_z);
  TH1F* h_mc_z_electron_bkg = (TH1F*)lmc_z_electron_bkg->Get(hname_z);

  TH1F* h_mc_w_muon_signal = (TH1F*)lmc_w_muon_signal->Get(hname_w);
  TH1F* h_mc_w_electron_signal = (TH1F*)lmc_w_electron_signal->Get(hname_w);
  TH1F* h_mc_z_muon_signal = (TH1F*)lmc_z_muon_signal->Get(hname_z);
  TH1F* h_mc_z_electron_signal = (TH1F*)lmc_z_electron_signal->Get(hname_z);

  if(surv>0.){
    h_mc_w_muon_signal->Scale(surv);
    h_mc_w_electron_signal->Scale(surv);
  ...
  if(makeXS){
    ...
    h_data_w_muon->Scale(1./lumi_w_muon,"width");
    h_data_w_electron->Scale(1./lumi_w_electron,"width");
    h_data_z_muon->Scale(1./lumi_z_muon,"width");
    h_data_z_electron->Scale(1./lumi_z_electron,"width");

    h_mc_w_muon_bkg->Scale(1./lumi_w_muon,"width");
    h_mc_w_electron_bkg->Scale(1./lumi_w_electron,"width");
    h_mc_z_muon_bkg->Scale(1./lumi_z_muon,"width");
    h_mc_z_electron_bkg->Scale(1./lumi_z_electron,"width");

    h_mc_w_muon_signal->Scale(1./lumi_w_muon,"width");
    h_mc_w_electron_signal->Scale(1./lumi_w_electron,"width");
  ...
  listdata->Add(h_data_w_muon);
  listdata->Add(h_data_w_electron);
  listdata->Add(h_data_z_muon);
  listdata->Add(h_data_z_electron);

  // All histograms bkg
  TList *listmcbkg = new TList;
  listmcbkg->Add(h_mc_w_muon_bkg);
  listmcbkg->Add(h_mc_w_electron_bkg);
  listmcbkg->Add(h_mc_z_muon_bkg);
  listmcbkg->Add(h_mc_z_electron_bkg);

  // All histograms signal
  TList *listmcsignal = new TList;
  listmcsignal->Add(h_mc_w_muon_signal);
  listmcsignal->Add(h_mc_w_electron_signal);
  ...
  listmcall->Add(h_mc_w_muon_signal);
  listmcall->Add(h_mc_w_electron_signal);
  listmcall->Add(h_mc_z_muon_signal);
  listmcall->Add(h_mc_z_electron_signal);
  listmcall->Add(h_mc_w_muon_bkg);
  listmcall->Add(h_mc_w_electron_bkg);
  listmcall->Add(h_mc_z_muon_bkg);
  listmcall->Add(h_mc_z_electron_bkg);

  TH1F *data = (TH1F*)h_data_w_muon->Clone("data");
  data->Reset();
  data->Merge(listdata);

  TH1F *bkg = (TH1F*)h_mc_w_muon_bkg->Clone("bkg");
  bkg->Reset();
  bkg->Merge(listmcbkg);

  TH1F *signal = (TH1F*)h_mc_w_muon_signal->Clone("signal");
  signal->Reset();
  signal->Merge(listmcsignal);

  TH1F *allmc = (TH1F*)h_mc_w_muon_bkg->Clone("allmc");
  allmc->Reset();
  allmc->Merge(listmcall);

}

void MyOfficialCMS(TString hname_w, TString hname_z){

  gStyle->SetOptFit(0);
  gStyle->SetOptStat(0);
  gStyle->SetOptTitle(0);

  loadFiles(hname_w, hname_z);
...
if(sigma){
  ...
  TLine *line = new TLine(0,0,xmax,0);
